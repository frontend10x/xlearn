...
<body>
    ...
    <div id="section__banner">
        <h2>¡Estás a un paso de entrenar a tus equipos en nuestra prueba piloto de la plataforma <span>Xlearn!</span>
        </h2>
    </div>
    ...
    <div class="content__button__activate">
        <a class="xln__btn__email" href="{{ $information['urlConfimation'] }}" target="_blank"
            data-saferedirecturl="{{$information['urlConfimation']}}">Activar ahora</a>
        <br />
        <br />
        <br />
    </div>
    ...
    <br />
    <p>Una vez realices el pago podrás empezar a explorar la plataforma, te recomendamos ver los siguientes tutoriales:
    </p>
    <br />
    ...
    <br />
    <br />
    <p>En esta fase piloto de Xlearn, todos tus aportes son muy valiosos, agradecemos que nos compartas tu experiencia,
        aspectos por mejorar o dudas que tengas a este correo.</p>
    <br />
    <br />
    ...
    <footer class="footer">
        <div class="container redes text-center">
            ...
            <a href="https://www.linkedin.com/in/xlearn-platform-409991240/" target="_blank"><i
                    class="fa fa-linkedin"></i></a>
            <a href="https://www.youtube.com/channel/UCyS1OiIhWpylctMcbSkYgFQ" target="_blank"><i
